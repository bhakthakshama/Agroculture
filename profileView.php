    ...
    <body>
        ...
        <section id="one" class="wrapper style1 align">
            <div class="inner">
                ...
                <header>
                    <center>
                    <img src="<?php echo 'images/profileImages/'.$_SESSION['picName'].'?'.mt_rand(); ?>" class="img-circle" class="img-responsive" height="50%" width="25%"></span>
                    <br>
                    ...
                    <div class="row">
                        <div class="col-sm-3"></div>
                        <div class="col-sm-3">
                            <b><font size="+1" color="black">EDUCATION : </font></b>
                            <font size="+1"><?php echo $_SESSION['Edu'];?></font>
                        </div>
                        <div class="col-sm-3">
                            <b><font size="+1" color="black">YEAR : </font></b>
                            <font size="+1"><?php echo $_SESSION['Year'];?></font>
                        </div>
                        <div class="col-sm-3"></div>
                        <div class="12u$">
                            <center>
