    ...
    <body class="subpage">
        ...
        <section id="post" class="wrapper bg-img" data-bg="banner2.jpg">
            <div class="inner">
                <div class="box">
                <header>
                    <span class="image left"><img src="<?php echo 'images/profileImages/'.$_SESSION['picName'].'?'.mt_rand(); ?>" class="img-circle" class="img-responsive" height="50%" width="25%"></span>
                    <br>
                ...
                <form method="post" action="Profile/updateProfile.php">
                    <div class="row uniform">
                        ...
                        <div class="3u 12u$(small)">
                            <input type="radio" id="btech" name="edu" value="B.TECH" checked>
                            <label for="btech">B.TECH</label>
                            
                        </div>
                         <div class="3u 12u$(small)">
                            <input type="radio" id="mtech" name="edu" value="M.TECH" checked>
                        ...
                        <div class="2u 12u$(small)">
                            <input type="radio" id="2" name="year" value="2" checked>
                            <label for="2">2<sup>nd</sup> Year</label>
                        
                        </div>
                        <div class="2u 12u$(small)">
                            <input type="radio" id="3" name="year" value="3" checked>
